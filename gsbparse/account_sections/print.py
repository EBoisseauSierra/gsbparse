...
class PrintSection(GsbFileSection):
    ...
    def from_xml(cls, element: ET.Element) -> Self:
        return cls(
            ...
            Font_transactions=element.attrib.get("Font_transactions"),
            Font_title=element.attrib.get("Font_title"),
            Report_font_transactions=element.attrib.get("Report_font_transactions"),
            Report_font_title=element.attrib.get("Report_font_title"),
        )
