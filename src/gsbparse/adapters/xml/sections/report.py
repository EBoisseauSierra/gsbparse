...
def parse_report_section(element: ET.Element) -> ReportSection:
    ...
    return ReportSection(
        ...
        Show_exclude_breakdown_child=parse_bool(a["Show_exclude_breakdown_child"]),
        ...
        Date_begining=parse_str(a["Date_begining"]),
        ...
        Split_day_begining=parse_int(a["Split_day_begining"]),
        ...
        Categ_exclude_transactions=parse_bool(a["Categ_exclude_transactions"]),
        ...
        Budget_exclude_transactions=parse_bool(a["Budget_exclude_transactions"]),
